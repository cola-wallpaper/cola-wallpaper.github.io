...
public class XListViewScrollView extends ListView implements OnScrollListener {
...
//		mHeaderTimeView.setText(TimeUtil.timeAgo(time));
	...
	public void setFooterView(View mFooterView, boolean mIsFooter) {
		addFooterView(mFooterView);
		this.mIsFooter = mIsFooter;
	}
	...
	public void stopRefresh() {
		if (mPullRefreshing == true) {
			mHeaderView.setState(XListViewHeader.STATE_DONE);
	...
	public void startHeaderRefresh() {
		updateHeaderHeight(getResources().getDimension(R.dimen.xlistview_headhight) / 1.8F);
		invokeOnScrolling();
		...
		if (this.mListViewListener != null) {
			...
			mHandler.sendEmptyMessageDelayed(0, 100);
				...
				XListViewScrollView.this.stopRefresh2();
		}
	}
	...
	public void startLoadMore() {
		...
		// mFooterView.setEnabled(false);
			...
			XListViewScrollView.this.stopLoadMore();
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
					...
					invokeOnScrolling();
						...
						&& (mFooterView.getBottomMargin() > 0 || deltaY < 0) && mIsFooter) {
...
//				mHeaderTimeView.setText(TimeUtil.timeAgo(time));
			...
			default:
				...
				if (getFirstVisiblePosition() == 0) {
					...
					resetHeaderHeight();
				} else if (getLastVisiblePosition() == mTotalItemCount - 1 && mIsFooter) {
					// invoke load more.
					if (mEnablePullLoad
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if(mEnablePullLoad && !mPullLoading && (getLastVisiblePosition() == mTotalItemCount - 1)) {
			startLoadMore();
		}
